        ...
        >
          ...
          {!sidebarCollapsed && (
            <div className="relative h-full flex flex-col">
                        ...
                        <ContextMenu>
                          <ContextMenuTrigger>
                            ...
                            >
                              ...
                              <ChevronRight
                                className={`w-2.5 h-2.5 text-gray-400 transition-transform ${expandedFolders.includes("general")
                                  ? "rotate-90"
                                  : ""
                                  }`}
                              />
                          ...
                          <div className="ml-3 sm:ml-5 space-y-0.5">
                            {(groupedChats.general || []).map((chat) => (
                              <ContextMenu key={chat.id}>
                                <ContextMenuTrigger>
                                  <div
                                    className={`group p-2 sm:p-1.5 rounded cursor-pointer text-xs hover:bg-gray-100 dark:hover:bg-[#565869] ${currentChatId === chat.id
                          ...
                          <ContextMenu>
                            <ContextMenuTrigger>
                              ...
                              >
                                ...
                                <ChevronRight
                                  className={`w-2.5 h-2.5 text-gray-400 transition-transform ${expandedFolders.includes("morngpt") ? "rotate-90" : ""
                                    }`}
                                />
                              </div>
                            </ContextMenuTrigger>
                            ...
                            <div className="ml-5 space-y-0.5">
                              {(groupedChats.morngpt || []).map((chat) => (
                                <ContextMenu key={chat.id}>
                                  <ContextMenuTrigger>
                                    <div
                                      className={`group p-1.5 rounded cursor-pointer text-xs hover:bg-gray-100 dark:hover:bg-[#565869] ${currentChatId === chat.id
                                        ? "bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300"
                                        : "text-gray-700 dark:text-gray-300"
                                        }`}
                                      onClick={() => selectChat(chat.id)}
                        ...
                        <ContextMenu>
                          <ContextMenuTrigger>
                            ...
                            >
                              ...
                              <ChevronRight
                                className={`w-2.5 h-2.5 text-gray-400 transition-transform ${expandedFolders.includes("external") ? "rotate-90" : ""
                                  }`}
                              />
                            </div>
                          </ContextMenuTrigger>
              ...
              {/* 回收站按钮 */}
              <div className="px-3 py-1.5 border-t border-gray-200 dark:border-[#565869] shrink-0">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setShowTrashDialog(true)}
                  className="w-full justify-start text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#565869] h-8"
                >
                  <Trash2 className="w-3.5 h-3.5 mr-2" />
                  {currentLanguage === "zh" ? "回收站" : "Recycle Bin"}
                </Button>
              </div>
