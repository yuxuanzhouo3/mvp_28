    ...
    try {
      if (mode === "signup") {
        ...
        if (isDomestic) {
          ...
          console.info("[AuthPage] INTL signup: signed out to prevent unverified access");
        ...
        if (isDomestic) {
          ...
          if (!data.user?.email_confirmed_at) {
            console.warn("[AuthPage] INTL login: email not confirmed, signing out");
            await supabase.auth.signOut();
            throw new Error(isZhText ? "请先验证您的邮箱，我们已发送确认邮件到您的邮箱。" : "Please verify your email first. We've sent a confirmation email to your inbox.");
          }
