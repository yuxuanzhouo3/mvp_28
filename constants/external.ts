...
export const externalAPIs: ExternalApi[] = [
  ...
  },
  {
    id: "gemini",
    name: "Gemini",
    description: "Google Gemma/Gemini 系列模型",
    icon: "sparkles",
    models: 1,
  },
  {
    id: "mistral",
    name: "Mistral",
    description: "Mistral / Codestral / Voxtral 系列",
...
export const externalModels: ExternalModel[] = [
  ...
  { id: "deepseek-r1", name: "DeepSeek-R1", provider: "DeepSeek", description: "深度推理模型 R1", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  { id: "deepseek-v3", name: "DeepSeek-V3", provider: "DeepSeek", description: "第三代通用模型", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  { id: "deepseek-v3.1", name: "DeepSeek-V3.1", provider: "DeepSeek", description: "V3.1 增强版", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  { id: "deepseek-v3.2-exp", name: "DeepSeek-V3.2-Exp", provider: "DeepSeek", description: "V3.2 实验版", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  { id: "Moonshot-Kimi-K2-Instruct", name: "Moonshot-Kimi-K2-Instruct", provider: "Kimi", description: "Kimi 文本增强模型", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  { id: "glm-4.6", name: "GLM-4.6", provider: "GLM", description: "智谱 GLM 4.6", category: "domestic", modality: "text", type: "paid", price: "N/A" },
  ...
  },
  {
    ...
    name: "Codestral-2412",
    provider: "Mistral",
    description: "Codestral 2412 release",
    category: "international",
    modality: "text",
    type: "paid",
    price: "N/A",
  },
  {
    ...
    provider: "Mistral",
    description: "Medium latest Mistral model",
    category: "international",
    modality: "text",
    type: "paid",
    price: "N/A",
  },
  {
    ...
    name: "Gemma 3 4B IT",
    provider: "Gemini",
    description: "Image + text understanding (international)",
    category: "international",
    modality: "multimodal",
    supportsImage: true,
    supportsVideo: false,
  ...
  },
  {
    ...
    name: "Voxtral Mini",
    provider: "Mistral",
    description: "Audio understanding and Q&A",
    category: "international",
    modality: "multimodal",
    supportsImage: false,
    supportsVideo: false,
